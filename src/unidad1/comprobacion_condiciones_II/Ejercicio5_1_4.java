...
public class Ejercicio5_1_4 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Introduce el número de horas trabajadas durante la semana:");
        horas = scanner.nextInt();

        if (horas <= 40) {
            System.out.println("El sueldo semanal que le corresponde es " + (horas * precioHoraNormal) + " euros");
        } else {
            System.out.println("El sueldo semanal que le corresponde es " + (((horas - 40) * PrecioHoraExtra) + 480 + " euros"));
        }
    }
}
